  ...
  return (
    <div className="stage-one-flow">
      ...
      {phase === 'predict' && selectedState ? <>
        ...
        {methodName === 'Pixel' && !results.some((item) => item.method === 'Pixel') ? <PixelLearningNote includeStrength /> : null}
